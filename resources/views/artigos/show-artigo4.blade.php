...
<body class="min-h-screen flex flex-col justify-between">
    ...
    <main class="container my-8">
        ...
        <div class="mb-6 text-center">
            <img src="{{ asset('img_artigos/artigo4-prin.png') }}" alt="Imagem do Post" class="post-image shadow-lg rounded-lg">
        </div>
        ...
        <div class="text-sm mt-6">
            ...
            <p>Publicado por Elizabete Farias</p>
        </div>
    </main>
        ...
        <div class="container-footer mx-auto flex justify-between items-start gap-6">
            ...
            <div class=" text-left">
                ...
                <div class="relative group cursor-pointer w-[600px] h-[150px] ml-[50px]">
                    ...
                    <img src="{{ asset('img_artigos/artigo4-seg.png') }}" alt="Imagem do Artigo"
                    ...
                    <div class="absolute inset-0 flex flex-col justify-center items-end pr-12">
                        <p class="text-black font-semibold text-lg text-right leading-snug">
                            <span class="font-bold">Ferramentas e Práticas para</span><br>
                            Implementar Design Inclusivo<br>
                            <span class="italic">em seus Projetos</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container-autor flex flex-col rounded-lg mr-32 border-b-4 items-center bg-lime-400 p-20 max-w-[200px]">
                <img src="{{ asset('img_artigos/artigo4-autor.png') }}" alt="Imagem do Autor"
                    class="rounded-full w-24 h-24 shadow-md mb-4  object-[40%_5%] ">
                <p class="font-bold text-lg text-center">Por <span class="text-blue-900">Elizabete Farias</span></p>
