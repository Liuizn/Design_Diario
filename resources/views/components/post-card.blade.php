<a href="{{ $postUrl }}" class="w-auto">
    <div class="flex flex-col p-0 bg-slate-200 rounded-lg shadow-md m-3 shadow-md cursor-pointer hover:brightness-125 transition ease-in-out delay-50" style="{{ $fullWidth == 'true' ? 'width: 744px;' : 'width: auto;' }} box-shadow: 0px 3px 12px 2px black;">
