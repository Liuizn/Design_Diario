<x-app-layout>
    <style>
        ...
        .comment {
            ...
            /* Fundo claro para os comentários */
            padding: 1rem;
            margin-top: 1.5rem;
            /* Distância entre os comentários */
            border-radius: 8px;
        ...
        .object-cover {
            ...
            /* Move a imagem 50px para a esquerda */
        }

        .relative.group {
            padding-left: 100px;
            /* Adiciona um espaçamento interno no container */
            position: relative;
            /* Garante que a imagem esteja contida */
        }

        .object-cover {
            width: 100%;
            /* Mantém a largura da imagem responsiva */
            height: 100%;
        ...
        .blur-overlay {
            position: absolute;
            /* Fixa o blur no mesmo lugar da imagem */
            inset: 0;
            /* Preenche todo o container da imagem */
            background-color: rgba(18, 30, 105, 0.3);
            /* Blur azul translúcido */
            backdrop-filter: blur(4px);
            /* Adiciona o efeito de blur */
            border-radius: 8px;
            /* Mesma borda arredondada da imagem */
            pointer-events: none;
    ...
    <main class="container my-12">
        ...
        <div class="mb-6 text-center">
            <img src="{{ asset('storage/' . $post->imagem) }}" alt="Imagem do Post"
                class="post-image shadow-lg rounded-lg">
        </div>
    ...
    <section class="container comments-section">
        ...
        <div class="space-y-4">
            <div class="comment">
                ...
                Amei as tendências! Estou particularmente animada com a ideia de trazer mais natureza para dentro de
                casa. Acho que as plantas realmente transformam o ambiente e dão uma sensação de paz.
            </div>
            <div class="comment">
            ...
            <div class="comment">
                ...
                Ótimo artigo, adorei a abordagem das tendências para 2025! Como profissional da área, tenho visto cada
                vez mais clientes pedindo soluções sustentáveis e tecnológicas para seus espaços.
            </div>
        </div>
        <!-- Add Comment Box -->
    ...
    <footer class="py-6">
        <div class="container-footer mx-auto flex justify-between items-start gap-6">
            ...
            <div class=" text-left">
                ...
                <div class="relative group cursor-pointer w-[600px] h-[150px] ml-[50px]">
                    ...
                    <img src="{{ asset('imagens/foto-nav-footer.png') }}" alt="Imagem do Artigo"
                        class="shadow-lg w-full h-full object-cover object-[20%_85%] rounded-lg"
            ...
            <div class="container-autor flex flex-col rounded-lg mr-32 border-b-4 items-center bg-lime-400 p-20 max-w-[200px]">
                <img src="{{asset('images/foto_perfil.svg')}}" alt="Imagem do Autor"
